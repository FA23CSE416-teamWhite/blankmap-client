        ...
        <Grid container>
            ...
            <Grid item xs={12} sm={6}>
                ...
                <MapContainer ref={mapRef} center={[39.9897471840457, -75.13893127441406]} zoom={11} scrollWheelZoom={true} style={{ height: '600px', width: '100%' }}>
                    ...
                    <PointMap addressPoints={points} render={render} setFeatures={setFeatures} setGeo={setGeojsonData} prevFeatures={features}/>
                    <LocationFinder/>
                    ...
                    <Popup>
                        ...
                        <TextField placeholder={points[idx][2]}  onChange={(e)=> handleEditPoint(e,idx)}/>
